...
export function generateDemoVisits(): StoredVisit[] {
  ...
  return [
    ...
    },
    {
      ...
      visit_date: d2,
      created_at: new Date(now.getTime() - 86400000 * 2 - 3600000 * 6).toISOString(),
    },
    {
      id: 'vis-demo-16',
      ...
      patient_age: 31,
      patient_gender: 'Female',
      doctor_name: 'David Kim',
      doctor_specialization: 'Pediatric & Sports Rehab',
      centre_id: 'c3333333-3333-3333-3333-333333333333',
      centre_name: 'Gurugram – DLF Phase 1',
      items: [
      ...
      visit_date: d4,
      created_at: new Date(now.getTime() - 86400000 * 4 - 3600000 * 5).toISOString(),
    },
  ]
}
